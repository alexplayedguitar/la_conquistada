                                ...
                                <table cellpadding="0" cellspacing="0" border="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="data:image/jpg;base64,<?php echo base64_encode($pp->imagen); ?>" width="50" height="50"></td>
											<td>
	                                            <a href="controller-edit-person.php?id_persona=<?php echo $pp->id_persona;?>"><i
	                                                    class="icon-edit"></i></a>
	                                            <a href="controller-edit-person.php?id_persona=<?php $pp->id_persona;?>&del=delete"
