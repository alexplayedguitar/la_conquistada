                    ...
                    <div class="content">
                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" name="Noticias" method="post"  enctype="multipart/form-data">
									...
									<div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="date" name="fecha" 
												value="<?php
															$date1=date_create($news->fecha);
															echo date_format($date1, 'Y-m-d');
														?>"
                                                placeholder="Ingrese fecha de noticia" class="span8 tip"
                                                required>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                           <img src="data:image/jpg;base64,<?php echo base64_encode($news->imagen); ?>" width="500" height="500">
                                        </div>
                                    </div>
									 <div class="control-group">
