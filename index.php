...
<head>
	...
	<title>La Conquistada | Portal de Administración</title>
...
<body>
			...
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
			  	...
			  	<a class="brand" href="index.html">
			  		La Conquistada | Portal de Administración
			  	</a>
				...
				<div class="nav-collapse collapse navbar-inverse-collapse">
					...
					<ul class="nav pull-right">
						...
						<li><a href="http://localhost/laconquistada/">
						Volver al sitio
	...
	<div class="footer">
		<div class="container">
			<b class="copyright">2019 La Conquistada </b> Todos los derechos reservados
		</div>
	</div>
