...
{?>
                                ...
                                <form class="form-horizontal row-fluid" name="insertproduct" method="post"
	                                ...
	                                <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="nombre" placeholder="Ingrese nombre de la artista"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="apellido" placeholder="Ingrese apellido del artista"
                                                class="span8 tip" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="apodo" placeholder="Ingrese apodo del artista"
                                                class="span8 tip" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select name="genero" class="span8 tip" onChange="getSubcat(this.value);"
                                                required>
                                                <option value="">Seleccionar género artístico</option>
                                                <!-- INICIO QUERY TRAE GENEROS ARTISTICOS CARGADOS EN BD -->
                                                <?php 
													foreach ($generos as $p) {
													?>
                                                <option value="<?php echo $p->id_genero;?>">
                                                    <?php echo $p->nombre;?></option>
                                                <?php } ?>
                                                <!-- FIN QUERY TRAE GENEROS ARTISTICOS CARGADOS EN BD -->
                                            </select>
                                        </div>
                                    </div>
								...
								<!-- INICIO INSERCIÓN IMAGEN -->
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <button type="submit" name="submit" class="btn">Cargar artista</button>
                                        </div>
                                    </div>
                                </form>
                                <!-- FIN FORMULARIO -->
...
{?>
                                ...
                                <table cellpadding="0" cellspacing="0" border="0"
                                    ...
                                    <tbody>
										<!-- INICIO QUERY QUE TRAE TODAS LOS ARTISTAS DE LA BD PARA DESPLEGARLAS EN LA SIGUIENTE GRILLA -->
                                        <?php 
											foreach ($artists as $ar)
											{
										?>
										<!-- FIN QUERY QUE TRAE TODAS LOS ARTIDTAS DE LA BD PARA DESPLEGARLAS EN LA SIGUIENTE GRILLA -->
                                        <tr>
                                            <td><?php echo $ar->id_artista;?></td>
                                            <td><?php echo $ar->nombre;?></td>
                                            <td><?php echo $ar->apellido;?></td>
                                            <td><?php echo $ar->nombre_pais;?></td>
                                            <td><?php echo $ar->apodo;?></td>
                                            <td><?php echo $ar->nombre_genero;?></td>
											<td><img src="data:image/jpg;base64,<?php echo base64_encode($ar->imagen); ?>" width="50" height="50"></td>
                                            <td>
	                                            <a href="controller-edit-artista.php?id=<?php echo $ar->id_artista;?>"><i
	                                                    class="icon-edit"></i></a>
	                                            <a href="view-artista.php?id=<?php echo $ar->id_artista;?>?>&del=delete"
	                                                onClick="return confirm('Artista será eliminado. ¿Está seguro?')"><i
